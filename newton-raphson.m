...
% Linear Solver: Custom Gauss Elimination
% =========================================================================
clear; clc;
...
%% =========================================================================
% Custom Linear Solver: Gauss Elimination with Partial Pivoting
% =========================================================================
function x = solve_gauss_elim(A, b)
    ...
    for k = 1:n-1
        % Partial Pivoting (Swap rows to maintain numerical stability)
