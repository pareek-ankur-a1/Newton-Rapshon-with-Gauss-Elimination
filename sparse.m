...
while iter < max_iter
    ...
    J11 = sparse(num_non_slack, num_non_slack);
    J12 = sparse(num_non_slack, num_pq);
    J21 = sparse(num_pq, num_non_slack);
    J22 = sparse(num_pq, num_pq);
    ...
    % Solve using mldivide, it does not take inverse
    % Uses UMFPACK C++ library that uses graph theory and optimal row-ordering to solve the system.
    dx = J \ mismatch;
